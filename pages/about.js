...
export default function About(){
    return(
        <Layout>
            <section className="bg-hdr-wood p-4 flex flex-col justify-end min-h-screen" >
                <div className="grid grid-cols-1 pt-12 md:pt-0 md:grid-cols-3 gap-8" >
                    <div className=" rounded bg-white p-4 flex flex-col justify-center items-center " >
                    ...
                    <div className=" rounded flex flex-col items-center justify-center bg-white p-4" >
